...
votings_pp <- triangles_g%>%
  filter(statement=="pp")%>%
  group_by(userA,userC)%>%
  summarise(count=n())
#the enemy of my friend
votings_np <- triangles_g%>%
  filter(statement=="np")%>%
  group_by(userA,userC)%>%
  summarise(count=n())
#the friend of my enemy
votings_pn <- triangles_g%>%
  filter(statement=="pn")%>%
  group_by(userA,userC)%>%
  summarise(count=n())
#the enemy of my enemy
votings_nn <- triangles_g%>%
  filter(statement=="nn")%>%
  group_by(userA,userC)%>%
  summarise(count=n())
...
#creating a data frame to store name of each vertex plus the six degrees calculated
Vdegrees<-matrix(data=NA,nrow=length(V(gtrain2)),ncol=7)
Vdegrees[,1]<-V(gtrain2)$name
Vdegrees[,2]<-V(gtrain2)$d_in_p
Vdegrees[,3]<-V(gtrain2)$d_out_p
Vdegrees[,4]<-V(gtrain2)$d_tot_p
Vdegrees[,5]<-V(gtrain2)$d_in_n
Vdegrees[,6]<-V(gtrain2)$d_out_n
Vdegrees[,7]<-V(gtrain2)$d_tot_n
colnames(Vdegrees)<-c("name", "d_in_p","d_out_p","d_tot_p","d_in_n","d_out_n","d_tot_n")
Vdegrees<-as.data.frame(Vdegrees)
#View(Vdegrees)

#creating a data frame with the "origin" and "destination" link of each edge
edgelist<-get.edgelist(gtrain2)
length(edgelist[,1])
colnames(edgelist)<-c("origin","destination")
edgelist<-as.data.frame(edgelist)
#View(edgelist)
...
#assigning values of the data frame as edge properties
gtrain2<-set.edge.attribute(gtrain2,"OinP",value=edgelist[,3])
gtrain2<-set.edge.attribute(gtrain2,"OoutP",value=edgelist[,4])
gtrain2<-set.edge.attribute(gtrain2,"OallP",value=edgelist[,5])
gtrain2<-set.edge.attribute(gtrain2,"OinN",value=edgelist[,6])
gtrain2<-set.edge.attribute(gtrain2,"OoutN",value=edgelist[,7])
gtrain2<-set.edge.attribute(gtrain2,"OallN",value=edgelist[,8])
gtrain2<-set.edge.attribute(gtrain2,"DinP",value=edgelist[,9])
gtrain2<-set.edge.attribute(gtrain2,"DoutP",value=edgelist[,10])
gtrain2<-set.edge.attribute(gtrain2,"DallP",value=edgelist[,11])
gtrain2<-set.edge.attribute(gtrain2,"DinN",value=edgelist[,12])
gtrain2<-set.edge.attribute(gtrain2,"DoutN",value=edgelist[,13])
gtrain2<-set.edge.attribute(gtrain2,"DallN",value=edgelist[,14])
...
```{r}
# CHUNK 6: same stuff as chunk 2, now for the test dataset
...
#creating a data frame to store name of each vertex plus the six degrees calculated
Vdegrees<-matrix(data=NA,nrow=length(V(gtest2)),ncol=7)
Vdegrees[,1]<-V(gtest2)$name
Vdegrees[,2]<-V(gtest2)$d_in_p
Vdegrees[,3]<-V(gtest2)$d_out_p
Vdegrees[,4]<-V(gtest2)$d_tot_p
Vdegrees[,5]<-V(gtest2)$d_in_n
Vdegrees[,6]<-V(gtest2)$d_out_n
Vdegrees[,7]<-V(gtest2)$d_tot_n
colnames(Vdegrees)<-c("name", "d_in_p","d_out_p","d_tot_p","d_in_n","d_out_n","d_tot_n")
Vdegrees<-as.data.frame(Vdegrees)
#View(Vdegrees)

#creating a data frame with the "origin" and "destination" link of each edge
edgelist<-get.edgelist(gtest2)
length(edgelist[,1])
colnames(edgelist)<-c("origin","destination")
edgelist<-as.data.frame(edgelist)
#View(edgelist)
...
#assigning values of the data frame as edge properties
gtest2<-set.edge.attribute(gtest2,"OinP",value=edgelist[,3])
gtest2<-set.edge.attribute(gtest2,"OoutP",value=edgelist[,4])
gtest2<-set.edge.attribute(gtest2,"OallP",value=edgelist[,5])
gtest2<-set.edge.attribute(gtest2,"OinN",value=edgelist[,6])
gtest2<-set.edge.attribute(gtest2,"OoutN",value=edgelist[,7])
gtest2<-set.edge.attribute(gtest2,"OallN",value=edgelist[,8])
gtest2<-set.edge.attribute(gtest2,"DinP",value=edgelist[,9])
gtest2<-set.edge.attribute(gtest2,"DoutP",value=edgelist[,10])
gtest2<-set.edge.attribute(gtest2,"DallP",value=edgelist[,11])
gtest2<-set.edge.attribute(gtest2,"DinN",value=edgelist[,12])
gtest2<-set.edge.attribute(gtest2,"DoutN",value=edgelist[,13])
gtest2<-set.edge.attribute(gtest2,"DallN",value=edgelist[,14])
